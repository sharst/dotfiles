...
def _target_tz(args):
    if args.target_timezone:
        return pytz.timezone(args.target_timezone)
    else:
        return tzlocal.get_localzone()
    ...
    if args.icalendar:
        ...
        for event_cal in events_:
            ...
            for event in events__:
                    ...
                    dtstart = dtstart.astimezone(_target_tz(args))
...
def main():
    ...
    parser.add_argument("--target_timezone", help="Timezone to convert events to")
